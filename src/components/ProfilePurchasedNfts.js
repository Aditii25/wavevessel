            ...
            <div className="nft-item-inside-two">
              <div className="status-bar">
                <div>
                  ...
                  <span className="value progress-title active">Active</span>
                </div>
          ...
          <div className="nft-item">
            ...
            <div className="nft-item-inside-two">
              <div className="status-bar">
                <div>
                  <span className="value progress-title">Status :- </span>
                  <span className="value progress-title active">Completed</span>
                </div>
                <div className="wallet_parent disabled">
                  <button className="wallet_button ">Revoke</button>
                </div>
              </div>
              <CustomProgressBar width={100} />
            </div>
          </div>
        </div>
      </section>
